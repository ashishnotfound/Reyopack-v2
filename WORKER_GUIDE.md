...
2. Keep the scanner cursor in the scan field. Scan an AWB, order identifier, or product SKU and press Enter if the scanner does not send Enter automatically.
